...
var DocumentationPaneComponent = (function () {
    function DocumentationPaneComponent(http, aspectRatio) {
        this.http = http;
     ...
     */
    DocumentationPaneComponent.prototype.ngOnInit = function () {
        this.getCSSJSONData();
        //this.createDynamicCSS();
    };
    DocumentationPaneComponent.prototype.onResize = function () {
        this.getCSSJSONData();
    };
    DocumentationPaneComponent.prototype.getCSSJSONData = function () {
    ...
    DocumentationPaneComponent.prototype.handleError = function (error) {
    };
    DocumentationPaneComponent.prototype.createDynamicCSS = function () {
    ...
    ], DocumentationPaneComponent.prototype, "onResize", null);
    DocumentationPaneComponent = __decorate([
        core_1.Component({
            selector: 'documentationpane',
            templateUrl: 'app/documentationpane/documentationpane.template.html'
        }), 
        __metadata('design:paramtypes', [http_1.Http, AspectRatioService_1.AspectRatioService])
    ], DocumentationPaneComponent);
    return DocumentationPaneComponent;
}());
exports.DocumentationPaneComponent = DocumentationPaneComponent;
//# sourceMappingURL=documentationpane.component.js.map