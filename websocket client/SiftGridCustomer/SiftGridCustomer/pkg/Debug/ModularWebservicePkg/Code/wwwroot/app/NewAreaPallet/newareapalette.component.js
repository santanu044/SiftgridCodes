...
var NewAreaPaletteComponent = (function () {
    function NewAreaPaletteComponent(aspectRatio, areaService, elementRef, http) {
    ...
    NewAreaPaletteComponent.prototype.ngOnInit = function () {
        // this.getCSSJSONData();
        this.CreateAreaPalette();
    };
    NewAreaPaletteComponent.prototype.onResize = function () {
        this.getCSSJSONData();
    };
    NewAreaPaletteComponent.prototype.getCSSJSONData = function () {
        var _this = this;
    ...
    NewAreaPaletteComponent.prototype.createDynamicCSS = function () {
    ...
    NewAreaPaletteComponent.prototype.CreateAreaPalette = function () {
    ...
    NewAreaPaletteComponent.prototype.collapse = function () {
        document.getElementById("newPalette").style.visibility = "hidden";
        //this.palletVisibility = true;
    };
    __decorate([
        core_1.ViewChild("myNewAreaPaletteDiv"), 
        __metadata('design:type', Object)
    ], NewAreaPaletteComponent.prototype, "div", void 0);
    __decorate([
        core_1.HostListener('window:resize'), 
        __metadata('design:type', Function), 
        __metadata('design:paramtypes', []), 
        __metadata('design:returntype', void 0)
    ], NewAreaPaletteComponent.prototype, "onResize", null);
    NewAreaPaletteComponent = __decorate([
        core_1.Component({
    ...
    return NewAreaPaletteComponent;
}());
exports.NewAreaPaletteComponent = NewAreaPaletteComponent;
//# sourceMappingURL=newareapalette.component.js.map