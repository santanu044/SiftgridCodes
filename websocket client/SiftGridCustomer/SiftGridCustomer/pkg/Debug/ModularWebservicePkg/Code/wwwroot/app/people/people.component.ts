...
export class PeopleComponent {
    ...
    public aspectRatio: AspectRatioService, private _authenticator: Authenticator
        , public diagramService: DiagramService, public timeservice: TimeMachineService) {
        diagramService.diagramTypeObservable.next("peoplediagram");
        peopleService.CreatePeopleDiagram$.subscribe(res => {
            this.Guid = res;
            console.log("Res : "+ res);
            this.DisplayPeopleDiagram(res);
        });
        ...
        timeservice.GetPeopleForTimeMachine.subscribe(res => {
            console.log(res);
        ...
        myDiagram.nodeTemplate = GO(go.Node, "Auto",
            ...
            GO(go.Panel, "Horizontal",
                ...
                GO(go.Panel, "Table",
                    ...
                    GO(go.TextBlock, "Person:",
                        { row: 0, column: 0, height: 13, width: 45,stroke: "white" }),
                    GO(go.TextBlock,  // the name
                            {
                                text: "(person)",
        ...
        myTree.nodeTemplate =
            GO(go.Node,
                ...
                GO(go.Panel, "Horizontal",
                    ...
                    new go.Binding("background", "isSelected", function (s) { return (s ? "#696969" : null); }).ofObject(),
                    GO(go.Picture,
                        {
                            width: 0, height: 18,
...
if(res =="visible"){
        this.peopleDiagram.isReadOnly = false;
}else {
...
var myOverview =
            GO(go.Overview, "myOverviewDiv2",  // the HTML DIV element for the Overview
    ...
    GetPeopleJson() {
        var JsonData;
        var self = this;
        (<HTMLInputElement>document.getElementById("peopleDiagram")).style.backgroundColor = "white";
        this.peopleService
    ...
    GetPeopleJsonForTimeMachine() {
        ...
        (<HTMLInputElement>document.getElementById("peopleDiagram")).style.backgroundColor = "gray";
        return JsonData;
    }
