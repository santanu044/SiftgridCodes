...
var Reminder = (function () {
    function Reminder(_http, router, companyservice) {
        this._http = _http;
    ...
    Reminder.prototype.sendmail = function (name) {
        var email;
        var company;
    ...
    Reminder.prototype.ngOnInit = function () {
        var _this = this;
    ...
    Reminder = __decorate([
        ...
        __metadata('design:paramtypes', [AuthenticatedHttpService_1.AuthenticatedHttpService, router_1.Router, company_service_1.CompanyService])
    ], Reminder);
    return Reminder;
}());
