...
export class PeopleCategoryComponent implements OnInit {
    ...
    createDynamicCSS() {
        ...
        let currentComponentWidth = this.aspectRatio.ComponentWidth(currentWidthRatio, (this.json["PeopleCategoryExpanded"])["width"]);
        let currentComponentHeight = this.aspectRatio.ComponentHeight(currentComponentWidth, (this.json["PeopleCategoryExpanded"])["height"] / (this.json["PeopleCategoryExpanded"])["width"]);
        let currentComponentLeft = this.aspectRatio.ComponentLeft(currentWidthRatio, (this.json["PeopleCategoryExpanded"])["left"]);
        let currentComponentTop = this.aspectRatio.ComponentTop(currentComponentLeft, (this.json["PeopleCategoryExpanded"])["top"] / (this.json["PeopleCategoryExpanded"])["left"]);
