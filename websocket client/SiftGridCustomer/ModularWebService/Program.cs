...
namespace ModularWebservice
{
    public class Program
    {
        ...
        {
            ServiceRuntime.RegisterServiceAsync("ModularWebserviceType", context => new WebHostingService(context, "ServiceEndpoint")).GetAwaiter().GetResult();

            TelemetryConfiguration.Active.InstrumentationKey = "ebd2a2b2-8f0a-47e3-b71e-3d9a86a3813e";
        ...
        internal sealed class WebHostingService : StatelessService, ICommunicationListener
        {
            ...
            //    string serverUrl = $"{endpoint.Protocol}://+:{endpoint.Port}/customer";
